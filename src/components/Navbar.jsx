// src/components/Navbar.js - Complete FULL working file with meeting notifications + Price List link
        ...
        <>
            <style>{`
                ...
                .pricelist-link:hover {
                    ...
                    transform: translateY(-2px);
                    box-shadow: 0 4px 15px rgba(107, 203, 119, 0.05);
                }
            ...
            <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
                ...
                <div className={`nav-links ${isMobile ? 'active' : ''}`}>
                    ...
                    {/* ============ PRICE LIST NAV LINK (NEW) ============ */}
                    <NavLink
                        to="/pricelist"
                        className={({ isActive }) => `nav-link pricelist-link ${isActive ? 'active' : ''}`}
                        onClick={closeMenu}
                    >
                        <span className="nav-icon">💰</span>
                        Price List
                    </NavLink>
                    {/* ============ END PRICE LIST NAV LINK ============ */}
