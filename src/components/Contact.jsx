// src/pages/Contact.js - Complete updated file (FIXED)
...
function Contact() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // ✅ contactData moved INSIDE handleSubmit where formData is available
            const contactData = {
                name: formData.name,
                ...
                status: 'pending',
                read: false,
                userId: auth.currentUser?.uid || null,          // ✅ ADDED
                userEmail: auth.currentUser?.email || formData.email, // ✅ ADDED
