// src/pages/Admin.js - Complete updated file
                                    ...
                                    <tr key={request.id} style={{ borderBottom: '1px solid rgba(255, 107, 107, 0.05)' }}>
                                        ...
                                        <td style={{ padding: '12px 16px' }}>
                                            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                                ...
                                                {assignedDevs.length > 0 && (
                                                    <button
                                                        onClick={() => openRemoveDeveloperModal(request)}
                                                        style={{
                                                            padding: '4px 12px',
                                                            background: 'rgba(255, 107, 107, 0.15)',
                                                            border: '1px solid rgba(255, 107, 107, 0.3)',
                                ...
                                <div style={{
                                    ...
                                    <input
                                        ...
                                        style={{
                                            width: '100%',
                                            padding: '10px 12px',
                                            background: uploadingImage ? 'rgba(255,255,255,0.03)' : 'rgba(255,217,61,0.05)',
                                            border: uploadingImage ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(255,217,61,0.2)',
                                            borderRadius: '10px',
                                            color: uploadingImage ? '#666' : '#FFD93D',
                                    ...
                                    />
                                    {uploadingImage && (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#FFD93D' }}>
                                            <span style={{
                                                display: 'inline-block',
                                                width: '20px',
                                                height: '20px',
                                    ...
                                    {developerFormData.photo && (
                                        <div style={{ marginTop: '5px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                            ...
                                            />
                                            <div>
                                                <span style={{ color: '#6BCB77', fontSize: '0.85rem' }}>✅ Image uploaded</span>
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        setDeveloperFormData(prev => ({ ...prev, photo: '' }));
                                                        if (fileInputRef.current) {
                                                            fileInputRef.current.value = '';
                                                        }
                                                    }}
                                    ...
                                    <div style={{ marginTop: '5px', color: '#666', fontSize: '0.75rem' }}>
                                        Upload a profile photo (JPG, PNG, GIF) - Max 10MB
                                    </div>
                                </div>
                            </div>
                        ...
                        <form onSubmit={saveOffer}>
                            <div style={{ marginBottom: '15px' }}>
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="e.g., 20% Off Web Development"
                                    style={{
                                        width: '100%',
                                        padding: '10px',
                                        background: 'rgba(255,255,255,0.05)',
            ...
            {showAssignModal && selectedRequestForAssign && (
                <div style={{
                    ...
                    <div style={{
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                gap: '10px',
                                                padding: '10px 12px',
                                                background: isSelected ? 'rgba(255, 217, 61, 0.1)' : 'rgba(255,255,255,0.03)',
                                                border: isSelected ? '2px solid #FFD93D' : '1px solid rgba(255,255,255,0.05)',
                                                borderRadius: '10px',
                                                cursor: 'pointer',
                                                transition: 'all 0.3s ease'
                                            }}
                                        >
                                            ...
                                            <div style={{ flex: 1 }}>
                                                <div style={{ color: '#E0E0E0', fontSize: '0.85rem', fontWeight: '500' }}>
                                                    {dev.name}
                                                </div>
                                                <div style={{ color: '#A8B2D1', fontSize: '0.7rem' }}>{dev.role}</div>
                                            </div>
                                            {isSelected && (
                                                <span style={{ color: '#FFD93D', fontSize: '1.2rem' }}>✅</span>
                                            )}
                                        </div>
                                    );
                                })}
                        ...
                        <div style={{ display: 'flex', gap: '15px', marginTop: '20px' }}>
                            <button
                                onClick={assignDevelopersToRequest}
                                disabled={assigningDeveloper || selectedDeveloperIds.length === 0}
                                style={{
                                    flex: 1,
                                    padding: '12px',
                                    background: selectedDeveloperIds.length > 0 
                                        ? 'linear-gradient(135deg, #FF6B6B 0%, #FFD93D 30%, #6BCB77 50%, #4D96FF 70%, #FF6BD6 100%)'
                                        : '#333',
                                    border: 'none',
                                    borderRadius: '10px',
                                    color: selectedDeveloperIds.length > 0 ? '#0A0E27' : '#666',
                                    fontWeight: 'bold',
                                    cursor: selectedDeveloperIds.length > 0 ? 'pointer' : 'not-allowed',
                                    fontSize: '1rem'
                                }}
                            >
            ...
            {showRemoveDeveloperModal && selectedRequestForRemove && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            <label style={{ display: 'block', marginBottom: '8px', color: '#FFD93D' }}>
                                Select Developer to Remove
                            </label>
                            <select
                                value={selectedDeveloperToRemove}
                                onChange={(e) => setSelectedDeveloperToRemove(e.target.value)}
                                style={{
                                    width: '100%',
                                    padding: '12px 16px',
                                    background: 'rgba(255,255,255,0.05)',
                        ...
                        <div style={{ display: 'flex', gap: '15px', marginTop: '20px' }}>
                            <button
                                onClick={removeDeveloperFromRequest}
                                style={{
                                    flex: 1,
                                    padding: '12px',
                                    background: '#FF6B6B',
