    ...
    const timeline = [
        {
            ...
            description: 'A platform to discover and manage franchise opportunities with ease',
            icon: '🔍',
            effect: 'neon-pulse',
            color: '#FF6B6B',
        ...
        },
        {
            ...
            description: 'Comprehensive import-export management system for global trade operations',
            icon: '🌐',
            effect: 'globe-spin',
            color: '#4D96FF',
        ...
        },
        {
            ...
            description: 'Integrated accounting and customer relationship management solution',
            icon: '📊',
            effect: 'data-wave',
            color: '#6BCB77',
    ...
    return (
        <>
            <style>{`
                ...
                /* Effect 1: NEON PULSE */
                .timeline-item.effect-neon-pulse .timeline-content {
                ...
                .timeline-item.effect-neon-pulse .timeline-content::after {
                    content: '';
                    position: absolute;
                    top: -50%;
                    left: -50%;
                ...
                .timeline-item.effect-neon-pulse .timeline-content:hover::after {
                    opacity: 1;
                ...
                /* Effect 3: DATA WAVE */
                .timeline-item.effect-data-wave .timeline-content {
                        ...
                        >
                            ...
                            <div className="timeline-content">
                                ...
                                <span className="timeline-badge">
                                    {index === 0 ? '🚀 Latest' : index === 1 ? '🌍 Global' : '💼 Enterprise'}
                                </span>
                            </div>
                        </div>
                    ))}
