    ...
    return (
        <>
            <style>{`
                ...
                .process-section {
                    padding: 90px 40px;
                    background: radial-gradient(ellipse at top, rgba(255, 107, 107, 0.05) 0%, transparent 70%);
                    text-align: center;
                    position: relative;
                    overflow: hidden;
                }
                ...
                .process-timeline::before {
                    ...
                    background: linear-gradient(
                        ...
                        rgba(255, 217, 61, 0.5),
                        rgba(107, 203, 119, 0.5),
                        rgba(77, 150, 255, 0.5),
                        rgba(255, 107, 214, 0.5),
                        transparent
                    );
                    z-index: 0;
                    animation: processFlow 4s linear infinite;
                ...
                @keyframes processPulse {
                    0%, 100% { box-shadow: 0 6px 20px rgba(255, 107, 107, 0.35); }
                    50% { box-shadow: 0 6px 30px rgba(255, 217, 61, 0.65); }
                }
                ...
                .process-step-icon {
                    ...
                    margin: 18px 0 10px;
                    display: inline-block;
                    animation: processFloat 3.5s ease-in-out infinite;
                ...
                .process-step-title {
                    ...
                    margin: 8px 0 10px;
                    font-weight: 800;
                    text-shadow: 0 0 25px rgba(255, 217, 61, 0.2);
                }
                ...
                /* animated glow inside each step */
                .process-step-glow {
                    position: absolute;
                    bottom: -40px;
                    left: 50%;
                ...
                .process-step:nth-child(5) .process-step-number {
                    background: linear-gradient(135deg, #FF6BD6, #FF6B6B);
                }
                ...
                .social-link:hover { transform: translateY(-8px) scale(1.05); }
                .social-link:hover .social-icon { transform: scale(1.2) rotate(5deg); }

                .social-link.instagram { border-color: rgba(225, 48, 108, 0.3); }
                ...
                .social-link.x-twitter { border-color: rgba(255, 255, 255, 0.15); }
                .social-link.x-twitter .social-icon { color: #FFFFFF; font-weight: bold; }
                ...
                .social-link.linkedin { border-color: rgba(0, 119, 181, 0.3); }
                ...
                .social-link.whatsapp { border-color: rgba(37, 211, 102, 0.3); }
                ...
                /* ============================================
                   FLOATING OFFER + AI CHATBOT (bottom-right)
                   ============================================ */
                ...
                .floating-offer-btn {
                    ...
                    background: linear-gradient(135deg, rgba(255, 217, 61, 0.18), rgba(255, 107, 107, 0.16));
                    color: #FFFFFF;
                    font-weight: 700;
                    font-size: 0.9rem;
                    cursor: pointer;
                    box-shadow: 0 10px 35px rgba(255, 217, 61, 0.28);
                    transition: all 0.3s ease;
                ...
                .floating-offer-btn:hover {
                    ...
                    border-color: #FFD93D;
                    background: linear-gradient(135deg, rgba(255, 217, 61, 0.3), rgba(255, 107, 107, 0.26));
                    box-shadow: 0 15px 45px rgba(255, 217, 61, 0.4);
                    animation-play-state: paused;
                }

                .floating-offer-btn .offer-btn-icon {
                    font-size: 1.2rem;
                    animation: offerGiftWiggle 2.4s ease-in-out infinite;
                }
                ...
                .ai-chatbot-messages::-webkit-scrollbar-track { background: #0a0e27; }
                .ai-chatbot-messages::-webkit-scrollbar-thumb { background: #FF6B6B; border-radius: 3px; }
                ...
                .ai-chatbot-input button:hover { transform: scale(1.05); }
                ...
                .offer-modal-icon {
                    ...
                    justify-content: center;
                    border-radius: 18px;
                    background: linear-gradient(135deg, rgba(255, 107, 107, 0.14), rgba(255, 217, 61, 0.14));
                    font-size: 2.2rem;
                }
                ...
                @media (max-width: 1200px) {
                    ...
                    .process-timeline { grid-template-columns: repeat(3, 1fr); gap: 22px; }
                ...
                @media (max-width: 768px) {
                    ...
                    .tech-stack-section { padding: 60px 20px; }
                    .tech-stack-section h2 { font-size: 2rem; }
                    .tech-grid { grid-template-columns: repeat(3, 1fr); gap: 12px; }
                    .tech-item { padding: 14px 10px; }
                    .tech-item .tech-icon { font-size: 1.8rem; }
                    .tech-item .tech-name { font-size: 0.7rem; }
                    .tech-category-title { font-size: 1.4rem; }
                    .stats-section {
                    ...
                    .contact-footer { padding: 40px 20px; }
                    .contact-footer h2 { font-size: 2rem; }
                    .contact-grid-footer { grid-template-columns: 1fr 1fr; gap: 15px; }
                    .contact-item { padding: 20px; }
                    .btn-primary, .btn-secondary { padding: 14px 35px; font-size: 0.95rem; }
                    .process-section { padding: 60px 20px; }
                    .process-title { font-size: 2rem; }
                    .process-timeline { grid-template-columns: 1fr; gap: 30px; margin-top: 20px; }
                    .process-step { padding: 32px 20px; }
                    .process-step-icon { font-size: 2.6rem; }
                    .ai-chatbot-window {
                        width: 90%;
                        right: 5%;
                        bottom: 100px;
                    ...
                    .ai-chatbot-button { width: 60px; height: 60px; font-size: 2rem; }
                    .floating-actions-container { bottom: 20px; right: 20px; gap: 10px; }
                    .floating-offer-btn { padding: 10px 14px; font-size: 0.8rem; }
                    .floating-offer-btn .offer-btn-icon { font-size: 1rem; }
                }
                ...
                @media (max-width: 480px) {
                    ...
                    .hero-tagline span { display: block; margin: 5px 0; }
                    .btn-primary, .btn-secondary { padding: 12px 25px; font-size: 0.85rem; }
                    ...
                    .tech-item .tech-name { font-size: 0.65rem; }
                    .tech-category-title { font-size: 1.2rem; }
                    .tech-category-title::before,
                    .tech-category-title::after { max-width: 30px; }
                    .stats-section { grid-template-columns: 1fr 1fr; gap: 10px; }
                    .stat-card { padding: 20px 15px; }
                    .stat-number { font-size: 2rem; }
                    .stat-icon { font-size: 1.8rem; }
                    .contact-footer h2 { font-size: 1.6rem; }
                    .contact-grid-footer { grid-template-columns: 1fr; }
                    .contact-footer .footer-btn { padding: 12px 25px; font-size: 0.9rem; }
                    .process-title { font-size: 1.6rem; }
                    .process-subtitle { font-size: 0.9rem; }
                    .process-step-title { font-size: 1rem; letter-spacing: 2px; }
                    .process-step-description { font-size: 0.8rem; }
                    .process-step-icon { font-size: 2.2rem; }
                    .offer-modal { padding: 26px 20px 20px; }
                    .offer-modal h3 { font-size: 1.3rem; }
                    .ai-chatbot-window { height: 400px; bottom: 90px; }
                    .floating-actions-container { bottom: 15px; right: 15px; }
                    .floating-offer-btn { padding: 9px 12px; font-size: 0.72rem; }
